...
function home(){stopTimers();app.innerHTML=`<div class="wrap anniversaryWrap">${head()}<section class="hero anniversaryHero"><div class="anniversaryBadge">🎂 10-Я ВЕРСИЯ</div><div class="anniversaryNumber" onclick="anniversarySecret()">10</div><h1>Юбилей Robom Games!</h1><p>Десятая версия уже здесь. Спасибо, что играете и следите за проектом. 🥳</p><div class="anniversaryInfo"><span>🎉 Праздничное обновление</span><span>🎁 Юбилейное меню</span><span>🎮 Все любимые игры на месте</span></div></section><div class="sectionTitle"><h2>🎮 Игры</h2><span>Юбилейное меню</span></div><div class="grid"><div class="game anniversaryGame"><div class="gameTop"><div><h2>🏐 Волейбол</h2><p>Играй в арене и получай +1 Токен каждые 30 секунд.</p></div><div class="gameIcon">🏐</div></div><button class="btn" onclick="volley()">Играть</button></div><div class="game anniversaryGame"><div class="gameTop"><div><h2>⚽ Набивание мяча</h2><p>Проверяй скорость и получай +1 Токен каждую секунду.</p></div><div class="gameIcon">⚽</div></div><button class="btn" onclick="kick()">Играть</button></div><div class="game soon anniversaryGame"><div class="gameTop"><div><h2>🏀 Баскетбол</h2><p>Новый режим уже в разработке.</p></div><div class="gameIcon">🏀</div></div><button class="btn" disabled>Скоро будет</button></div><div class="game dev anniversaryGame"><div class="gameTop"><div><h2>🛠️ Для разработчиков</h2><p>Служебная панель для управления валютой аккаунта.</p></div><div class="gameIcon">🛠️</div></div><button class="btn" onclick="developerLogin()">Открыть</button></div></div><section class="anniversaryFooter"><b>🎁 Маленький секрет спрятан прямо на цифре 10</b><span>Нажми на неё, если любишь пасхалки.</span></section><p class="small recovery">Потеряли аккаунт? Напишите на <a href="mailto:gamedevelover@tokman.net">gamedevelover@tokman.net</a></p><p class="small" style="text-align:center;opacity:.65;margin-top:14px">Robom Games v10 • Юбилей 🎂</p></div>`}
